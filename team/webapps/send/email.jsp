...
<body>
 <section class="section">
    	<div class="container">
			...
			<div class="frm1">
				<form name="frm" class="frm" action="emailPro.jsp" method="post">
					<table class="table">
						<tbody>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="title" id="title" maxlength="100" class="input" required></td>
							</tr>
							<tr>
					...
					<div class="btn_group">
						<button type="submit" class="button is-primary">메일보내기</button>
					</div>
				</form>
			</div>
		</div>
