...
public class GetSignDetailCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SignDTO signDetail = dao.getSignDetail(sno);
		request.setAttribute("datail", signDetail);
		
		//DAO 데이터를 view에 디스패치
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/sign/signDetail.jsp");
