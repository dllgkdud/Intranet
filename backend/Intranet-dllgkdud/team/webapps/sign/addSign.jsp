...
<body>
	...
	<section class="section">
		<div class="container">
			<h2></h2>
			<form action="${path1 }/AddSignCtrl.do" method="post">
				<table class="table">
					<tbody>
						<tr>
						...
						<tr>
							...
							<td><textarea cols="100" rows="10" name="content" id="content" class="textarea is-info" maxlength="900" placeholder="내용" style="resize:none;" required></textarea></td>
						</tr>
					</tbody>
				</table>
